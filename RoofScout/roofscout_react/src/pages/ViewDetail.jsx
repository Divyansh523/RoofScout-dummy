...
export default function ViewDetail() {
  ...
  useEffect(() => {
    const fetchPropertyData = async () => {
      ...
      try {
        const res = await fetch(`http://localhost:5000/api/properties/${houseId}/view`);
        ...
        if (res.ok && data && data.success) {
          ...
          setPropertyData(prev => ({
            ...
            owner: (prop.owner && (prop.owner.name || prop.owner)) || prop.ownerName || prev.owner,
            ownerEmail: (prop.owner && prop.owner.email) || prop.ownerEmail || prev.ownerEmail,
                ...
                <div className="mb-8">
                  <button
                    onClick={() => {
                      ...
                      const currentEmail = (getStoredJSON("userProfile", {}) || {}).email || "";

                      const displayName = (getStoredJSON("userProfile", {}) || {}).name || sessionStorage.getItem("loggedUser") || "";
